...
class Block_Setup {
	...
	public function register_block_patterns() {
		 ...
		 * }
		 */
		$block_pattern_categories = apply_filters( 'lsxd_block_pattern_categories', $block_pattern_categories );
		 ...
		 */
		$block_patterns = apply_filters( 'lsxd_block_patterns', $block_patterns );
