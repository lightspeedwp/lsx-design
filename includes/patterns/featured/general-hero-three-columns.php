...
<h2 class="has-text-align-center has-x-large-font-size" id="image-heading-text-button-1">' .   esc_html__( 'Image, heading, text, button.', 'lsx' ). '</h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full"><img src="' .  esc_url( get_theme_file_uri() ) . '/assets/images/lsxd-placeholder-contrast-1200x1200.jpg'. '"  alt="' .   esc_attr__( 'Sample Image', 'lsx' ). '" class="wp-image-676"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link no-border-radius">' .   esc_html__( 'Learn More', 'lsx' ). '</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":3} -->
<h3 class="has-text-align-center" id="sample-heading-2">' .   esc_html__( 'Sample Heading', 'lsx' ). '</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris finibus dolor ex, non hendrerit purus vulputate blandit.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":3} -->
<h3 class="has-text-align-center" id="sample-heading-3">' .   esc_html__( 'Sample Heading', 'lsx' ). '</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris finibus dolor ex, non hendrerit purus vulputate blandit.</p>
<!-- /wp:paragraph -->
