...
return array(
    ...
    <div class="wp-block-column"><!-- wp:cover {"id":1318,"overlayColor":"contrast","minHeight":60,"minHeightUnit":"vh","contentPosition":"center center","align":"full","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|medium"}}}} -->
    ...
    <div class="wp-block-buttons wp-block-button has-custom-width wp-block-button__width-75 is-style-fill"><!-- wp:button {"textColor":"base","width":50,"className":"is-style-fill"} -->
    <div class="wp-block-button has-custom-width wp-block-button__width-50 is-style-fill"><a class="wp-block-button__link has-base-color has-text-color wp-element-button">View More</a></div>
    <!-- /wp:button --></div>
    <!-- /wp:buttons --></div>
    <!-- /wp:column --></div>
    <!-- /wp:columns --></div>
