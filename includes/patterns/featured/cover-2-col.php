...
return array(
    ...
    <div class="wp-block-column"><!-- wp:cover {"url":"' . esc_url( get_theme_file_uri() ) . '/assets/images/lsxd-placeholder-contrst-1920x1200.jpg","dimRatio":40,"customOverlayColor":"#000000","minHeight":60,"minHeightUnit":"vh","contentPosition":"center center","align":"full","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|medium"}}}} -->
    <div class="wp-block-cover alignfull" style="margin-bottom:var(--wp--preset--spacing--medium);min-height:60vh"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-40 has-background-dim" style="background-color:#000000"></span><img class="wp-block-cover__image-background" alt="" src="' . esc_url( get_theme_file_uri() ) . '/assets/images/lsxd-placeholder-contrst-1920x1200.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"center","style":{"typography":{"fontSize":"48px","lineHeight":"1.2"}},"className":"wp-block-heading alignwide has-white-color has-text-color","anchor":""} -->
