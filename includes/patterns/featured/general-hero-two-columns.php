...
return array(
	...
	<h2 class="has-x-large-font-size" id="text-on-left-image-on-right">' . esc_html__( 'Text on left, media on right.', 'lsx-design' ) . '</h2>
	<!-- /wp:heading -->
	<!-- wp:paragraph -->
	...
	<div class="wp-block-button is-style-fill"><a class="wp-block-button__link no-border-radius wp-element-button">' . esc_html__( 'Get Started', 'lsx-design' ) . '</a></div>
	<!-- /wp:button -->
	<!-- wp:button {"style":{"border":{"radius":0}},"className":"is-style-outline"} -->
	<div class="wp-block-button is-style-outline"><a class="wp-block-button__link no-border-radius wp-element-button">' . esc_html__( 'Learn More', 'lsx-design' ) . '</a></div>
	<!-- /wp:button --></div>
