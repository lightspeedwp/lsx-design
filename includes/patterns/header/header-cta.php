...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"bottom":"var(--wp--preset--spacing--large, 1rem)","top":"var(--wp--preset--spacing--small, 1.00rem)"}}},"layout":{"type":"flex","justifyContent":"space-between","flexWrap":"nowrap"}} -->
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--x-small, 1.00rem);padding-bottom:var(--wp--preset--spacing--x-small, 1rem)"><!-- wp:group {"layout":{"type":"flex"}} -->
