...
return array(
    ...
    <p class="has-text-align-center">' .  esc_html__( 'Company Name', 'lsx' ). '<br><a href="mailto:name@company.com">name@company.com</a></p>
    <!-- /wp:paragraph -->
    ...
    <div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link no-border-radius">' .  esc_html__( 'Visit My Website', 'lsx' ). '</a></div>
    <!-- /wp:button -->
    <!-- wp:button {"width":100,"style":{"border":{"radius":0}}} -->
    <div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link no-border-radius">' .  esc_html__( 'Read My Blog', 'lsx' ). '</a></div>
    <!-- /wp:button -->
    <!-- wp:button {"width":100,"style":{"border":{"radius":0}}} -->
    <div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link no-border-radius">' .  esc_html__( 'Download My Ebook', 'lsx' ). '</a></div>
    <!-- /wp:button -->
    <!-- wp:button {"width":100,"style":{"border":{"radius":0}}} -->
    <div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link no-border-radius">' .  esc_html__( 'Follow My Newsletter', 'lsx' ). '</a></div>
    <!-- /wp:button -->
    <!-- wp:button {"width":100,"style":{"border":{"radius":0}}} -->
    <div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link no-border-radius">' .  esc_html__( 'Listen to My Podcast', 'lsx' ). '</a></div>
    <!-- /wp:button -->
    </div>
    <!-- /wp:buttons -->
    ...
    <!-- /wp:spacer -->
    <!-- wp:paragraph {"align":"center"} -->
    <p class="has-text-align-center"><a href="https://lsdev.biz/">' .  esc_html__( 'Made with LSX', 'lsx' ). '</a></p>
    <!-- /wp:paragraph --></div>
    <!-- /wp:group --></div>
    <!-- /wp:group -->
    ',
