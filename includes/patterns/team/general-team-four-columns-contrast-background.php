...
return array(
	'title'      => __( 'Team 4 Column Contract', 'lsx-design' ),
...
<h2 class="has-text-align-center has-x-large-font-size" id="our-team">' . esc_html__( 'Our Team', 'lsx-design' ) . '</h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|medium"}}}} -->
<p class="has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--medium)">' . esc_html__( 'The people who are ready to serve you.', 'lsx-design' ) . '</p>
<!-- /wp:paragraph -->
...
<h3 class="has-text-align-center has-medium-font-size" id="member-name-1">' . esc_html__( 'Member Name', 'lsx-design' ) . '</h3>
<!-- /wp:heading -->
...
<p class="has-text-align-center"><a href="#">' . esc_html__( 'View profile', 'lsx-design' ) . '</a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":3488,"sizeSlug":"full","linkDestination":"none"} -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":3,"fontSize":"medium"} -->
<h3 class="has-text-align-center has-medium-font-size" id="member-name-2">' . esc_html__( 'Member Name', 'lsx-design' ) . '</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":3,"fontSize":"medium"} -->
<h3 class="has-text-align-center has-medium-font-size" id="member-name-3">' . esc_html__( 'Member Name', 'lsx-design' ) . '</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Lorem ipsum dolor sit amet, consectetur et adipiscing.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":3,"fontSize":"medium"} -->
<h3 class="has-text-align-center has-medium-font-size" id="member-name-4">' . esc_html__( 'Member Name', 'lsx-design' ) . '</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Lorem ipsum dolor sit amet, consectetur et adipiscing.</p>
<!-- /wp:paragraph -->
