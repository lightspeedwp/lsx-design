...
= How do I add a social icon menu to the footer? =
...
The menu appears in the footer.

Available icons: (Linking to any of the following sites will automatically display its icon in your social menu).

Social networks that aren’t currently supported will be indicated by a generic share icon. Read more about the social menu config.
